...
func (a *Application) Start() {
	...
	adminAPIRouter.HandleFunc("GET /sendctfdpasswords", a.HandleSendCTFdPasswords)
	adminAPIRouter.HandleFunc("GET /ctfd/teams", a.HandleCTFdTeamsExport)
	adminAPIRouter.HandleFunc("GET /ctfd/users", a.HandleCTFdUsersExport)
